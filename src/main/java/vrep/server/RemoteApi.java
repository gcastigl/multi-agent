...
/**
 * DO NOT even think on CHANGING THE PACKAGE NOR THE NAME of this class. The
 * library should be compiled again if you wish to do so.
 */
public class RemoteApi {
	...
	public native int simxStart(final String connectionAddress,
			int connectionPort, boolean waitUntilConnected,
			boolean doNotReconnectOnceDisconnected, int timeOutInMs);

	public native void simxFinish();

	public native int simxGetConnectionId();

	public native int simxGetObjectHandle(final String objectName, IntW handle,
			int operationMode);

	public native int simxGetJointPosition(int jointHandle, FloatW position,
			int operationMode);

	public native int simxSetJointPosition(int jointHandle, float position,
			int operationMode);

	public native int simxGetObjectPosition(int objectHandle,
			int relativeToObjectHandle, FloatWA position, int operationMode);

	public native int simxSetObjectPosition(int objectHandle,
			int relativeToObjectHandle, final FloatWA position,
			int operationMode);

	public native int simxGetVisionSensorImage(int sensorHandle,
			IntWA resolution, CharWA image, int options, int operationMode);

	public native int simxSetVisionSensorImage(int sensorHandle, CharWA image,
			int bufferSize, int options, int operationMode);

	public native int simxGetJointMatrix(int jointHandle, FloatWA matrix,
			int operationMode);

	public native int simxSetSphericalJointMatrix(int jointHandle,
			FloatWA matrix, int operationMode);

	public native int simxSetJointTargetVelocity(int jointHandle,
			float targetVelocity, int operationMode);

	public native int simxSetJointTargetPosition(int jointHandle,
			float targetPosition, int operationMode);

	public native int simxJointGetForce(int jointHandle, FloatW force,
			int operationMode);

	public native int simxSetJointForce(int jointHandle, float force,
			int operationMode);

	public native int simxReadForceSensor(int forceSensorHandle, IntW state,
			FloatWA forceVector, FloatWA torqueVector, int operationMode);

	public native int simxBreakForceSensor(int forceSensorHandle,
			int operationMode);

	public native int simxReadVisionSensor(int sensorHandle,
			BoolW detectionState, FloatWAA auxValues, int operationMode);

	public native int simxGetObjectFloatParameter(int objectHandle,
			int parameterID, FloatW parameterValue, int operationMode);

	public native int simxSetObjectFloatParameter(int objectHandle,
			int parameterID, float parameterValue, int operationMode);

	public native int simxGetObjectIntParameter(int objectHandle,
			int parameterID, IntW parameterValue, int operationMode);

	public native int simxSetObjectIntParameter(int objectHandle,
			int parameterID, int parameterValue, int operationMode);

	public native int simxGetModelProperty(int objectHandle, IntW prop,
			int operationMode);

	public native int simxSetModelProperty(int objectHandle, int prop,
			int operationMode);

	public native int simxGetVisionSensorDepthBuffer(int sensorHandle,
			IntWA resolution, FloatWA buffer, int operationMode);

	public native int simxGetObjectChild(int parentObjectHandle,
			int childIndex, IntW childObjectHandle, int operationMode);

	public native int simxGetObjectParent(int childObjectHandle,
			IntW parentObjectHandle, int operationMode);

	public native int simxStartSimulation(int operationMode);

	public native int simxPauseSimulation(int operationMode);

	public native int simxStopSimulation(int operationMode);

	public native int simxGetUISlider(int uiHandle, int uiButtonID,
			IntW position, int operationMode);

	public native int simxSetUISlider(int uiHandle, int uiButtonID,
			int position, int operationMode);

	public native int simxGetUIEventButton(int uiHandle, IntW uiEventButtonID,
			IntWA auxValues, int operationMode);

	public native int simxGetUIButtonProperty(int uiHandle, int uiButtonID,
			IntW prop, int operationMode);

	public native int simxSetUIButtonProperty(int uiHandle, int uiButtonID,
			int prop, int operationMode);

	public native int simxAuxiliaryConsoleClose(int consoleHandle,
			int operationMode);

	public native int simxAuxiliaryConsoleShow(int consoleHandle,
			boolean showState, int operationMode);

	public native int simxGetObjectOrientation(int objectHandle,
			int relativeToObjectHandle, FloatWA eulerAngles, int operationMode);

	public native int simxSetObjectParent(int objectHandle, int parentObject,
			boolean keepInPlace, int operationMode);

	public native int simxGetArrayParameter(int paramIdentifier,
			FloatWA paramValues, int operationMode);

	public native int simxSetArrayParameter(int paramIdentifier,
			FloatWA paramValues, int operationMode);

	public native int simxGetIntegerParameter(int paramIdentifier,
			IntW paramValue, int operationMode);

	public native int simxSetIntegerParameter(int paramIdentifier,
			int paramValue, int operationMode);

	public native int simxGetBooleanParameter(int paramIdentifier,
			BoolW paramValue, int operationMode);

	public native int simxGetDialogResult(int dialogHandle, IntW result,
			int operationMode);

	public native int simxSetFloatingParameter(int paramIdentifier,
			float paramValue, int operationMode);

	public native int simxRemoveObject(int objectHandle, int operationMode);

	public native int simxRemoveUI(int uiHandle, int operationMode);

	public native int simxCloseScene(int operationMode);

	public native int simxEndDialog(int dialogHandle, int operationMode);

	public native int simxReadDistance(int distanceObjectHandle,
			FloatW minimumDistance, int operationMode);

	public native int simxGetFloatingParameter(int paramIdentifier,
			FloatW paramValue, int operationMode);

	public native int simxSetObjectOrientation(int objectHandle,
			int relativeToObjectHandle, FloatWA eulerAngles, int operationMode);

	public native int simxReadProximitySensor(int sensorHandle,
			BoolW detectionState, FloatWA detectedPoint,
			IntW detectedObjectHandle, FloatWA detectedSurfaceNormalVector,
			int operationMode);

	public native int simxLoadModel(final String modelPathAndName, int options,
			IntW baseHandle, int operationMode);

	public native int simxLoadUI(final String uiPathAndName, int options,
			IntWA uiHandles, int operationMode);

	public native int simxLoadScene(final String scenePathAndName, int options,
			int operationMode);

	public native int simxGetUIHandle(final String uiName, IntW handle,
			int operationMode);

	public native int simxAddStatusbarMessage(final String message,
			int operationMode);

	public native int simxAuxiliaryConsoleOpen(final String title,
			int maxLines, int mode, IntWA position, IntWA size,
			FloatWA textColor, FloatWA backgroundColor, IntW consoleHandle,
			int operationMode);

	public native int simxAuxiliaryConsolePrint(int consoleHandle,
			final String txt, int operationMode);

	public native int simxSetUIButtonLabel(int uiHandle, int uiButtonID,
			final String upStateLabel, final String downStateLabel,
			int operationMode);

	public native int simxGetLastErrors(StringWA errorStrings, int operationMode);

	public native int simxSetBooleanParameter(int paramIdentifier,
			boolean paramValue, int operationMode);

	public native int simxGetStringParameter(int paramIdentifier,
			StringW paramValue, int operationMode);

	public native int simxGetCollisionHandle(final String collisionObjectName,
			IntW handle, int operationMode);

	public native int simxGetDistanceHandle(final String distanceObjectName,
			IntW handle, int operationMode);

	public native int simxReadCollision(int collisionObjectHandle,
			BoolW collisionState, int operationMode);

	public native int simxGetObjects(int objectType, IntWA objectHandles,
			int operationMode);

	public native int simxDisplayDialog(final String titleText,
			final String mainText, int dialogType, final String initialText,
			FloatWA titleColors, FloatWA dialogColors, IntW dialogHandle,
			IntW uiHandle, int operationMode);

	public native int simxGetDialogInput(int dialogHandle, StringW inputText,
			int operationMode);

	public native int simxCopyPasteObjects(IntWA objectHandles,
			IntWA newObjectHandles, int operationMode);

	public native int simxGetObjectSelection(IntWA objectHandles,
			int operationMode);

	public native int simxSetObjectSelection(IntWA objectHandles,
			int operationMode);

	public native int simxClearFloatSignal(final String signalName,
			int operationMode);

	public native int simxClearStringSignal(final String signalName,
			int operationMode);

	public native int simxClearIntegerSignal(final String signalName,
			int operationMode);

	public native int simxGetFloatSignal(final String signalName,
			FloatW signalValue, int operationMode);

	public native int simxGetIntegerSignal(final String signalName,
			IntW signalValue, int operationMode);

	public native int simxGetStringSignal(final String signalName,
			StringW signalValue, int operationMode);

	public native int simxSetFloatSignal(final String signalName,
			float signalValue, int operationMode);

	public native int simxSetIntegerSignal(final String signalName,
			int signalValue, int operationMode);

	public native int simxSetStringSignal(final String signalName,
			final String signalValue, int operationMode);

	public native int simxGetPingTime(IntW pingTime);

	public native int simxGetLastCmdTime();

	public native int simxSynchronousTrigger();

	public native int simxSynchronous(boolean enable);

	public native int simxPauseCommunication(boolean enable);

	public native int simxGetInMessageInfo(int infoType, IntW info);

	public native int simxGetOutMessageInfo(int infoType, IntW info);

	public native int simxTransferFile(final String filePathAndName,
			final String fileName_serverSide, int timeOut, int operationMode);

	public native int simxEraseFile(final String fileName_serverSide,
			int operationMode);

	public static final int SIMX_HEADER_SIZE = 18;
	public static final int simx_headeroffset_crc = 0; /*
														 * 1 simxUShort.
														 * Generated by the
														 * client or server. The
														 * CRC for the message
														 */
	public static final int simx_headeroffset_version = 2; /*
															 * 1 byte. Generated
															 * by the client or
															 * server. The
															 * version of the
															 ...
															 * software
															 */
	public static final int simx_headeroffset_message_id = 3; /*
															 * 1 simxInt.
															 * Generated by the
															 * client (and used
															 * in a reply by the
															 * server)
															 */
	public static final int simx_headeroffset_client_time = 7; /*
																 * 1 simxInt.
																 * Client time
																 * stamp
																 * generated by
																 ...
																 * server)
																 */
	public static final int simx_headeroffset_server_time = 11; /*
																 * 1 simxInt.
																 * Generated by
																 * the server
																 * when a reply
																 ...
																 * timestamp
																 */
	public static final int simx_headeroffset_scene_id = 15; /*
															 * 1 simxUShort.
															 * Generated by the
															 * server. A unique
															 * ID identifying
															 ...
															 * displayed
															 */
	public static final int simx_headeroffset_server_state = 17; /*
																 * 1 byte.
																 * Generated by
																 * the server.
																 * Bit coded: 0
	...
	public static final int simx_cmdheaderoffset_mem_size = 0; /*
																 * 1 simxInt.
																 * Generated by
																 * the client or
																 * server. The
																 ...
																 * command.
																 */
	public static final int simx_cmdheaderoffset_full_mem_size = 4; /*
																	 * 1
																	 * simxInt.
																	 * Generated
																	 * by the
																	 ...
																	 * chunks).
																	 */
	public static final int simx_cmdheaderoffset_pdata_offset0 = 8; /*
																	 * 1
																	 * simxUShort
																	 * .
																	 * Generated
																	 ...
																	 * .
																	 */
	public static final int simx_cmdheaderoffset_pdata_offset1 = 10; /*
																	 * 1
																	 * simxInt.
																	 * Generated
																	 * by the
																	 ...
																	 * chunks).
																	 */
	public static final int simx_cmdheaderoffset_cmd = 14; /*
															 * 1 simxInt.
															 * Generated by the
															 * client (and used
															 * in a reply by the
															 ...
															 * the command.
															 */
	public static final int simx_cmdheaderoffset_delay_or_split = 18; /*
																	 * 1
																	 * simxUShort
																	 * .
																	 * Generated
																	 ...
																	 * ).
																	 */
	public static final int simx_cmdheaderoffset_sim_time = 20; /*
																 * 1 simxInt.
																 * Generated by
																 * the server.
																 * The
																 ...
																 * not running)
																 */
	public static final int simx_cmdheaderoffset_status = 24; /*
															 * 1 byte. Generated
															 * by the server.
															 * (1: bit 0 is set
															 * --> error in
															 ...
															 * overwritten
															 */
	public static final int simx_cmdheaderoffset_reserved = 25; /*
																 * 1 byte. Not
																 * yet used
																 */
	...
	public static final int sim_objectspecialproperty_detectable_all = 16 | 32
			| 64 | 128 | 256;
	...
	public static final int sim_modelproperty_not_respondable = 64; /*
																	 * cannot be
																	 * selected
																	 * if
																	 ...
																	 * selected
																	 */
	public static final int sim_modelproperty_not_reset = 128; /*
																 * Model is not
																 * reset at
																 * simulation
																 * end. This
																 ...
																 * end
																 */
	public static final int sim_modelproperty_not_visible = 256; /*
																 * Whole model
																 * is invisible,
																 * independent
																 * of local
																 ...
																 * settings
																 */
	public static final int sim_modelproperty_not_model = 61440; /*
																 * object is not
																 * a model
																 */
	...
	public static final int sim_message_ui_button_state_change = 0; /*
																	 * a UI
																	 * button,
																	 * slider,
																	 * etc.
	...
	public static final int sim_message_keypress = 6; /*
													 * a key was pressed while
													 * the focus was on a page
													 * (aux[0]=key, aux[1]=ctrl
													 * and shift key state)
													 */
	public static final int sim_message_bannerclicked = 7; /*
															 * a banner was
															 * clicked
															 * (aux[0]=banner
															 * ID)
	...
	/*
	 * Following messages are dispatched only to the C-API (not available from
	 * Lua):
	 */
	public static final int sim_message_for_c_api_only_start = 256; /*
																	 * Do not
																	 * use
																	 */
	...
	public static final int sim_message_eventcallback_scenesave = 260; /*
																		 * about
																		 * to
																		 * save
																		 * a
																		 * scene
																		 */
	public static final int sim_message_eventcallback_modelsave = 261; /*
																		 * about
																		 * to
																		 * save
																		 * a
																		 ...
																		 * )
																		 */
	public static final int sim_message_eventcallback_moduleopen = 262; /*
																		 * called
																		 * when
																		 * simOpenModule
																		 * in
																		 ...
																		 * called
																		 */
	public static final int sim_message_eventcallback_modulehandle = 263; /*
																		 * called
																		 * when
																		 * simHandleModule
																		 * in
																		 ...
																		 * false
																		 */
	public static final int sim_message_eventcallback_moduleclose = 264; /*
																		 * called
																		 * when
																		 * simCloseModule
																		 * in
	...
	public static final int sim_message_eventcallback_instancepass = 269; /*
																		 * Called
																		 * once
																		 * every
																		 * main
	...
	/*
	 * bit6 set: scene switched (similar to scene loaded, basically: scene
	...
	public static final int sim_message_eventcallback_reserved1 = 276; /*
																		 * do
																		 * not
																		 * use
																		 */
	public static final int sim_message_eventcallback_reserved2 = 277; /*
																		 * do
																		 * not
																		 * use
																		 */
	public static final int sim_message_eventcallback_reserved3 = 278; /*
																		 * do
																		 * not
																		 * use
																		 */
	public static final int sim_message_eventcallback_reserved4 = 279; /*
																		 * do
																		 * not
																		 * use
																		 */

	public static final int sim_message_eventcallback_abouttoundo = 280; /*
																		 * the
																		 * undo
																		 * button
																		 * was
																		 ...
																		 * restored
																		 */
	public static final int sim_message_eventcallback_undoperformed = 281; /*
																			 * the
																			 * undo
																			 * button
																			 * was
																			 ...
																			 * restored
																			 */
	public static final int sim_message_eventcallback_abouttoredo = 282; /*
																		 * the
																		 * redo
																		 * button
																		 * was
																		 ...
																		 * restored
																		 */
	public static final int sim_message_eventcallback_redoperformed = 283; /*
																			 * the
																			 * redo
																			 * button
																			 * was
																			 ...
																			 * restored
																			 */
	public static final int sim_message_eventcallback_scripticondblclick = 284; /*
																				 * scipt
																				 * icon
																				 * was
																				 * double
	...
	public static final int sim_message_eventcallback_reserved5 = 287; /*
																		 * do
																		 * not
																		 * use
																		 */
	public static final int sim_message_eventcallback_keypress = 288; /*
																	 * a key was
																	 * pressed
																	 * while the
																	 * focus was
																	 ...
																	 * state)
																	 */
	public static final int sim_message_eventcallback_modulehandleinsensingpart = 289; /*
																						 * called
																						 * when
																						 * simHandleModule
																						 * in
	...
	public static final int sim_message_eventcallback_renderingpass = 290; /*
																			 * called
																			 * just
																			 * before
																			 * the
																			 ...
																			 * rendered
																			 */
	public static final int sim_message_eventcallback_bannerclicked = 291; /*
																			 * called
																			 * when
																			 * a
																			 * banner
																			 ...
																			 * )
																			 */
	public static final int sim_message_eventcallback_menuitemselected = 292; /*
																			 * auxiliaryData
																			 * [
																			 * 0
																			 * ]
																			 ...
																			 * item
																			 */
	public static final int sim_message_eventcallback_refreshdialogs = 293; /*
																			 * aux[
																			 * 0
																			 * ]
																			 * =
	...
	public static final int sim_objectproperty_reserved5 = 4; /*
															 * formely
															 * sim_objectproperty_visible
															 */
	public static final int sim_objectproperty_reserved6 = 8; /*
															 * formely
															 * sim_objectproperty_wireframe
															 */
	...
	public static final int sim_simulation_advancing = 16; /*
															 * Simulation is
															 * advancing
															 */
	public static final int sim_simulation_advancing_firstafterstop = 16 | 0; /*
																			 * First
																			 * simulation
																			 * pass
																			 * (
																			 ...
																			 * )
																			 */
	public static final int sim_simulation_advancing_running = 16 | 1; /*
																		 * Normal
																		 * simulation
																		 * pass
																		 * (
	...
	public static final int sim_simulation_advancing_lastbeforepause = 16 | 3; /*
																				 * Last
																				 * simulation
																				 * pass
																				 * before
																				 ...
																				 * )
																				 */
	public static final int sim_simulation_advancing_firstafterpause = 16 | 4; /*
																				 * First
																				 * simulation
																				 * pass
																				 * after
																				 ...
																				 * )
																				 */
	public static final int sim_simulation_advancing_abouttostop = 16 | 5; /*
																			 * "Trying to stop"
																			 * simulation
																			 * pass
																			 * (
																			 ...
																			 * )
																			 */
	public static final int sim_simulation_advancing_lastbeforestop = 16 | 6; /*
																			 * Last
																			 * simulation
																			 * pass
																			 * (
	...
	public static final int sim_scripttype_threaded = 240; /*
															 * Combine with one
															 * of above's type
															 * values
															 */
	...
	public static final int sim_api_errormessage_ignore = 0; /*
															 * does not memorize
															 * nor output errors
															 */
	public static final int sim_api_errormessage_report = 1; /*
															 * memorizes errors
															 * (default for
															 * C-API calls)
															 */
	public static final int sim_api_errormessage_output = 2; /*
															 * memorizes and
															 * outputs errors
															 * (default for
															 * Lua-API calls)
	...
	public static final int sim_dlgstyle_dont_center = 32; /*
															 * can be combined
															 * with one of above
															 * values. Only with
															 * this flag can the
	...
	public static final int sim_drawing_points = 0; /*
													 * 3 values per point (point
													 * size in pixels)
													 */
	public static final int sim_drawing_lines = 1; /*
													 * 6 values per line (line
													 * size in pixels)
													 */
	public static final int sim_drawing_triangles = 2; /* 9 values per triangle */
	public static final int sim_drawing_trianglepoints = 3; /*
															 * 6 values per
															 * point (3 for
															 * triangle
															 * position, 3 for
															 ...
															 * size in meters)
															 */
	public static final int sim_drawing_quadpoints = 4; /*
														 * 6 values per point (3
														 * for quad position, 3
														 * for quad normal
														 * vector) (quad size in
														 * meters)
														 */
	public static final int sim_drawing_discpoints = 5; /*
														 * 6 values per point (3
														 * for disc position, 3
														 * for disc normal
														 * vector) (disc size in
														 * meters)
														 */
	public static final int sim_drawing_cubepoints = 6; /*
														 * 6 values per point (3
														 * for cube position, 3
														 * for cube normal
														 * vector) (cube size in
														 * meters)
														 */
	public static final int sim_drawing_spherepoints = 7; /*
														 * 3 values per point
														 * (sphere size in
														 * meters)
														 */
	...
	public static final int sim_drawing_itemcolors = 32; /*
														 * +3 values per item
														 * (each item has its
														 * own ambient color
														 * (r,g,b values)).
														 ...
														 */
	public static final int sim_drawing_vertexcolors = 64; /*
															 * +3 values per
															 * vertex (each
															 * vertex has its
															 * own ambient color
															 ...
															 */
	public static final int sim_drawing_itemsizes = 128; /*
														 * +1 value per item
														 * (each item has its
														 * own size). Not for
														 * sim_drawing_triangles
														 */
	public static final int sim_drawing_backfaceculling = 256; /*
																 * back faces
																 * are not
																 * displayed for
																 * all items
																 */
	public static final int sim_drawing_wireframe = 512; /*
														 * all items displayed
														 * in wireframe
														 */
	public static final int sim_drawing_painttag = 1024; /*
														 * all items are tagged
														 * as paint (for
														 * additinal processing
														 * at a later stage)
														 */
	public static final int sim_drawing_followparentvisibility = 2048; /*
																		 * if
																		 * the
																		 * object
																		 * is
																		 ...
																		 * visible
																		 */
	public static final int sim_drawing_cyclic = 4096; /*
														 * if the max item count
														 * was reached, then the
														 * first items are
														 * overwritten.
														 */
	public static final int sim_drawing_50percenttransparency = 8492; /*
																	 * the
																	 * drawing
																	 * object
																	 * will be
																	 ...
																	 * transparent
																	 */
	public static final int sim_drawing_25percenttransparency = 16384; /*
																		 * the
																		 * drawing
																		 * object
																		 * will
																		 ...
																		 * transparent
																		 */
	public static final int sim_drawing_12percenttransparency = 32768; /*
																		 * the
																		 * drawing
																		 * object
																		 * will
																		 ...
																		 * transparent
																		 */
	public static final int sim_drawing_emissioncolor = 65536; /*
																 * When used in
																 * combination
																 * with
																 * sim_drawing_itemcolors
																 ...
																 * component
																 */
	public static final int sim_drawing_facingcamera = 131072; /*
																 * Only for
																 * trianglepoints
																 * , quadpoints,
																 * discpoints
																 ...
																 * values less)
																 */
	public static final int sim_drawing_overlay = 262144; /*
														 * When specified,
														 * objects are always
														 * drawn on top of
														 * "regular objects"
														 */
	public static final int sim_drawing_itemtransparency = 524288; /*
																	 * +1 value
																	 * per item
																	 * (each
																	 * item has
	...
	/* banner values: */
	/* following can be or-combined: */
	public static final int sim_banner_left = 1; /*
												 * Banners display on the left
												 * of the specified point
												 */
	public static final int sim_banner_right = 2; /*
												 * Banners display on the right
												 * of the specified point
												 */
	public static final int sim_banner_nobackground = 4; /*
														 * Banners have no
														 * background rectangle
														 */
	public static final int sim_banner_overlay = 8; /*
													 * When specified, banners
													 * are always drawn on top
													 * of "regular objects"
													 */
	public static final int sim_banner_followparentvisibility = 16; /*
																	 * if the
																	 * object is
																	 * associated
																	 * with a
																	 ...
																	 * visible
																	 */
	public static final int sim_banner_clickselectsparent = 32; /*
																 * if the object
																 * is associated
																 * with a scene
																 * object, then
																 ...
																 * scene object
																 */
	public static final int sim_banner_clicktriggersevent = 64; /*
																 * if the banner
																 * is clicked,
																 * an event is
																 * triggered (
																 ...
																 * generated)
																 */
	public static final int sim_banner_facingcamera = 128; /*
															 * If specified, the
															 * banner will
															 * always face the
															 * camera by
															 ...
															 * (y-axis)
															 */
	public static final int sim_banner_fullyfacingcamera = 256; /*
																 * If specified,
																 * the banner
																 * will always
																 * fully face
																 ...
																 * it)
																 */
	public static final int sim_banner_backfaceculling = 512; /*
															 * If specified, the
															 * banner will only
															 * be visible from
															 * one side
															 */
	public static final int sim_banner_keepsamesize = 1024; /*
															 * If specified, the
															 * banner will
															 * always appear in
															 * the same size. In
															 ...
															 * in pixels
															 */
	public static final int sim_banner_bitmapfont = 2048; /*
														 * If specified, a
														 * fixed-size bitmap
														 * font is used. The
														 * text will also always
														 * fully face the camera
														 * and be right to the
														 * specified position.
														 * Bitmap fonts are not
														 * clickable
														 */

	/* particle objects: */
	/* following are mutually exclusive: */
	public static final int sim_particle_points1 = 0; /*
													 * 6 values per point (pt1
													 * and pt2. Pt1 is start
													 * position, pt2-pt1 is the
													 * initial velocity vector).
													 * Point is 1 pixel big.
													 * Only appearance is a
													 * point, internally handled
													 * as a perfect sphere
													 */
	public static final int sim_particle_points2 = 1; /*
													 * 6 values per point. Point
													 * is 2 pixel big. Only
													 * appearance is a point,
													 * internally handled as a
													 * perfect sphere
													 */
	public static final int sim_particle_points4 = 2; /*
													 * 6 values per point. Point
													 * is 4 pixel big. Only
													 * appearance is a point,
													 * internally handled as a
													 * perfect sphere
													 */
	public static final int sim_particle_roughspheres = 3; /*
															 * 6 values per
															 * sphere. Only
															 * appearance is
															 * rough. Internally
															 * a perfect sphere
															 */
	public static final int sim_particle_spheres = 4; /*
													 * 6 values per sphere.
													 * Internally a perfect
													 * sphere
													 */

	/* following can be or-combined: */
	public static final int sim_particle_respondable1to4 = 32; /*
																 * the particles
																 * are
																 * respondable
																 * against
																 ...
																 * mask)
																 */
	public static final int sim_particle_respondable5to8 = 64; /*
																 * the particles
																 * are
																 * respondable
																 * against
																 ...
																 * mask)
																 */
	public static final int sim_particle_particlerespondable = 128; /*
																	 * the
																	 * particles
																	 * are
																	 * respondable
																	 ...
																	 * other
																	 */
	public static final int sim_particle_ignoresgravity = 256; /*
																 * the particles
																 * ignore the
																 * effect of
																 * gravity. Not
																 ...
																 * sim_particle_water
																 */
	public static final int sim_particle_invisible = 512; /*
														 * the particles are
														 * invisible
														 */
	public static final int sim_particle_itemsizes = 1024; /*
															 * +1 value per
															 * particle (each
															 * particle can have
															 * a different size)
															 */
	public static final int sim_particle_itemdensities = 2048; /*
																 * +1 value per
																 * particle
																 * (each
																 * particle can
																 ...
																 * density)
																 */
	public static final int sim_particle_itemcolors = 4096; /*
															 * +3 values per
															 * particle (each
															 * particle can have
															 * a different
															 * color)
															 */
	public static final int sim_particle_cyclic = 8192; /*
														 * if the max item count
														 * was reached, then the
														 * first items are
														 * overwritten.
														 */
	public static final int sim_particle_emissioncolor = 16384; /*
																 * When used in
																 * combination
																 * with
																 ...
																 * component
																 */
	public static final int sim_particle_water = 32768; /*
														 * the particles are
														 * water particles (no
														 * weight in the water
														 * (i.e. when z<0)). Not
														 ...
														 */
	public static final int sim_particle_painttag = 65536; /*
															 * The particles can
															 * be seen by vision
															 * sensors (
	...
	/* Integer parameters: */
	public static final int sim_intparam_error_report_mode = 0; /*
																 * Check
																 * sim_api_errormessage_
																 * ... constants
																 * above for
																 * valid values
																 */
	public static final int sim_intparam_program_version = 1; /*
															 * e.g Version 2.1.4
															 * --> 20104. Can
															 * only be read
															 */
	public static final int sim_intparam_instance_count = 2; /*
															 * do not use
															 * anymore (always
															 * returns 1 since
															 * V-REP 2.5.11)
															 */
	public static final int sim_intparam_custom_cmd_start_id = 3; /*
																 * can only be
																 * read
																 */
	public static final int sim_intparam_compilation_version = 4; /*
																 * 0=evaluation
																 * version,
																 * 1=full
																 * version,
	...
	public static final int sim_intparam_flymode_camera_handle = 6; /*
																	 * can only
																	 * be read
																	 */
	public static final int sim_intparam_dynamic_step_divider = 7; /*
																	 * can only
																	 * be read
																	 */
	public static final int sim_intparam_dynamic_engine = 8; /*
															 * 0=Bullet, 1=ODE.
															 * Can only be read
															 */
	public static final int sim_intparam_server_port_start = 9; /*
																 * can only be
																 * read
																 */
	public static final int sim_intparam_server_port_range = 10; /*
																 * can only be
																 * read
																 */
	...
	public static final int sim_intparam_server_port_next = 15; /*
																 * is
																 * initialized
																 * at
																 * sim_intparam_server_port_start
																 */
	public static final int sim_intparam_qt_version = 16; /*
														 * version of the used
														 * Qt framework
														 */
	public static final int sim_intparam_event_flags_read = 17; /*
																 * can only be
																 * read
																 */
	public static final int sim_intparam_event_flags_read_clear = 18; /*
																	 * can only
																	 * be read
																	 */
	public static final int sim_intparam_platform = 19; /* can only be read */
	public static final int sim_intparam_scene_unique_id = 20; /*
																 * can only be
																 * read
																 */
	...
	/* String parameters: */
	public static final int sim_stringparam_application_path = 0; /*
																 * path of
																 * V-REP's
																 * executable
																 */
	...
	/*
	 * Navigation and selection modes with the mouse. Lower byte values are
	 * mutually exclusive, upper byte bits can be combined
	 */
	...
	/*
	 * Bit-combine following values and add them to one of above's values for a
	...
	public static final int simx_error_novalue_flag = 1; /*
														 * input buffer doesn't
														 * contain the specified
														 * command
														 */
	public static final int simx_error_timeout_flag = 2; /*
														 * command reply not
														 * received in time for
														 * simx_opmode_oneshot_wait
														 * operation mode
														 */
	public static final int simx_error_illegal_opmode_flag = 4; /*
																 * command
																 * doesn't
																 * support the
																 * specified
																 ...
																 * mode
																 */
	public static final int simx_error_remote_error_flag = 8; /*
															 * command caused an
															 * error on the
															 * server side
															 */
	public static final int simx_error_split_progress_flag = 16; /*
																 * previous
																 * similar
																 * command not
																 * yet fully
																 ...
																 * modes)
																 */
	public static final int simx_error_local_error_flag = 32; /*
															 * command caused an
															 * error on the
															 * client side
															 */
	public static final int simx_error_initialize_error_flag = 64; /*
																	 * simxStart
																	 * was not
																	 * yet
																	 * called
	...
	public static final int simx_opmode_oneshot = 0; /*
													 * sends command as one
													 * chunk. Reply will also
													 * come as one chunk.
													 * Doesn't wait for the
													 * reply.
													 */
	public static final int simx_opmode_oneshot_wait = 65536; /*
															 * sends command as
															 * one chunk. Reply
															 * will also come as
															 * one chunk. Waits
															 * for the reply (
															 * _REPLY_WAIT_TIMEOUT_IN_MS
															 * is the timeout).
															 */
	...
	public static final int simx_opmode_oneshot_split = 196608; /*
																 * sends command
																 * as several
																 * chunks (max
																 * chunk size is
	...
	public static final int simx_opmode_discontinue = 327680; /*
															 * removes and
															 * cancels all
															 * commands stored
															 * on the client or
															 ...
															 * commands)
															 */
	public static final int simx_opmode_buffer = 393216; /*
														 * doesn't send
														 * anything, but checks
														 * if a reply for the
														 * given command is
														 ...
														 * from the server)
														 */
	public static final int simx_opmode_remove = 458752; /*
														 * doesn't send anything
														 * and doesn't return
														 * any specific value.
														 * It just erases a
														 * similar command reply
														 * in the inbox (to free
														 * some memory)
														 */
